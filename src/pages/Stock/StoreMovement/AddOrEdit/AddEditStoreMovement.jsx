...
const AddEditStoreMovement = ()=>{
    ...
    let getNextCode = async()=>{
        ...
        dispatch(edit_store_movement({DocNo: nextCode}));
    }
        ...
        <>
            ...
            <div className="w-full flex justify-between border-b pb-4 mb-4">
                ...
                <div className="flex gap-4">
                    <Button disabled={!myData?.StockItems?.length || !myData?.StockItems[0]?.ProductID || isLoading} type="primary" onClick={handleSubmit} icon={isLoading ? <LoadingOutlined/> : <SaveOutlined />}>حفظ</Button>
                    {id &&
