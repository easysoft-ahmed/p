...
export const SalesInvoiceSlice = createSlice({
  ...
  reducers: {
    edit_sales_invoice: (state, {payload})=>{      
        state.value = {...state.value, ...payload};        
    },
    update_sales_invoice: (state, {payload})=>{
        state.value = payload;
    },
    init_state_sales_invoice: (state)=>{
      state.value = { 
...
export const {updateTotalValueAndTax, edit_sales_invoice, update_sales_invoice,  init_state_sales_invoice, modified_tables_sales_invoice } = SalesInvoiceSlice.actions
