...
const AddEditCodeCashFlow = ()=>{
    return(
        <>
            <div className="flex flex-wrap justify-center">
                <div className="w-full flex justify-between border-b pb-4 mb-4">
                    <h3 className="text-lg font-bold">إضافة بند</h3>
                ...
                <div className="flex flex-wrap w-full sm:w-8/12 md:w-6/12 lg:w-4/12">
                    ...
                    <div className="input_label_basic w-6/12">
                        <label htmlFor="">التصنيف المحاسبي</label>
                            <Select
                                showSearch
                                placeholder="-- غير محدد --"
                                allowClear
                    ...
                    <div className="input_label_basic w-6/12 text-center pe-2">
                        <label htmlFor="">مصروف شهري ثابت</label>
...
export default AddEditCodeCashFlow;