...
import { edit_purch_invoice } from "../statePurchInvoice";
                ...
                <div className="flex flex-wrap w-full">
                    ...
                    <div className="input_label_basic w-full lg:w-2/12">
                        ...
                        <Select
                            ...
                            allowClear
                            onChange={(val, opt)=>{
                                dispatch(edit_purch_invoice({CurrID: opt.CurrID, CurrRate: opt.CurrRate}))
                            }}
                            value={myData?.CurrID}
                    ...
                    <div className="input_label_basic pe-4 w-full lg:w-3/12">
                        ...
                        <Select 
                            ...
                            onChange={value => dispatch(edit_purch_invoice({SideType: value, CustomerId: "", CustomerName: "", SellerID: "", SellerName: "", VendorID: "", VendorName: ""}))}
                        >
                    ...
                    <div className="input_label_basic w-full lg:w-3/12">
                        ...
                        <Select className="w-full"
                            ...
                            onChange={(val , opt) => dispatch(edit_purch_invoice({SellerID: opt.SellerID, SellerName: opt.SellerName}))}
                            filterOption={(input, option) =>
                                (option?.label ?? '').toLowerCase().includes(input.toLowerCase())
                            }
                            showSearch
