...
export const PurchOrderSlice = createSlice({
  name: 'purch_order',
  initialState:{
    value: {}
  },
  reducers: {
    edit_purch_order: (state, {payload})=>{      
        state.value = {...state.value, ...payload};        
    },
    update_purch_order: (state, {payload})=>{
        state.value = payload;
    },
    init_state_purch_order: (state)=>{
      state.value = {
    ...
    modified_tables_purch_order: (state, {payload})=>{
...
export const {updateTotalValueAndTax, edit_purch_order, update_purch_order,  init_state_purch_order, modified_tables_purch_order } = PurchOrderSlice.actions

export default PurchOrderSlice.reducer
