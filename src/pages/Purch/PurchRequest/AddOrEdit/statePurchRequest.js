...
export const PurchRequestSlice = createSlice({
  name: 'purch_request',
  initialState:{
    value: {}
  },
  reducers: {
    edit_purch_request: (state, {payload})=>{      
        state.value = {...state.value, ...payload};        
    },
    update_purch_request: (state, {payload})=>{
        state.value = payload;
    },
    init_state_purch_request: (state)=>{
      state.value = {
    ...
    modified_tables_purch_request: (state, {payload})=>{
...
export const {updateTotalValueAndTax, edit_purch_request, update_purch_request,  init_state_purch_request, modified_tables_purch_request } = PurchRequestSlice.actions

export default PurchRequestSlice.reducer
