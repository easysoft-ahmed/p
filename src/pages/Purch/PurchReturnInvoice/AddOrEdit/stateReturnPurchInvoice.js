...
export const ReturnPurchInvoiceSlice = createSlice({
  name: 'return_purch_invoice',
  initialState:{
    value: {}
  },
  reducers: {
    edit_return_purch_invoice: (state, {payload})=>{      
        state.value = {...state.value, ...payload};        
    },
    update_return_purch_invoice: (state, {payload})=>{
        state.value = payload;
    },
    init_state_return_purch_invoice: (state)=>{
      state.value = {
        DocID: "", DocNo: "", BranchId: 1, SerialId: "", OtherDocNo: "", DocDate:  dayjs().format("YYYY/MM/DD"), DueDate:  dayjs().format("YYYY/MM/DD"),
    ...
    modified_tables_return_purch_invoice: (state, {payload})=>{
...
export const {updateTotalValueAndTax, edit_return_purch_invoice, update_return_purch_invoice,  init_state_return_purch_invoice, modified_tables_return_purch_invoice } = ReturnPurchInvoiceSlice.actions

export default ReturnPurchInvoiceSlice.reducer
